...
const SCENES = [
  ...
  { id: 'chains', text: 'DobDex is deployed on three chains. Arbitrum Sepolia with the full Uniswap V4 hook integration. Robinhood Chain with DobDirectSwap, optimized for 100 millisecond block times and retail RWA trading. And Base Sepolia demonstrating multi-chain portability.' },
  ...
  { id: 'roadmap', text: 'Looking ahead, we are building the DobValidatorRegistry oracle in Rust via Arbitrum Stylus for 10 to 100x cheaper gas. An AI agent marketplace for autonomous validators and LP strategy agents. Cross-chain dUSDC via LayerZero. And mainnet deployment on Arbitrum One and Robinhood Chain.' },
  { id: 'cta', text: 'DobDex. Zero slippage RWA liquidity infrastructure. Try the live demo, explore the code on GitHub, or read the protocol documentation. Built for Arbitrum Open House NYC. 340 thousand dollars in prizes.' },
];
